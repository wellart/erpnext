	...
	records = [
		...
		{'doctype': "Setup Progress", "actions": [
			...
			{"action_name": "Add Rooms", "action_doctype": "Room", "min_doc_count": 1, "is_completed": 0,
				"domains": '["Education"]' },
			{"action_name": "Add Users", "action_doctype": "User", "min_doc_count": 4, "is_completed": 1,
				"domains": '[]' },
			{"action_name": "Add Letterhead", "action_doctype": "Letter Head", "min_doc_count": 1, "is_completed": 1,
				"domains": '[]' }
		]},
		...
		# salary component
		{'doctype': 'Salary Component', 'salary_component': _('BPJS Tenagakerja'), 'description': _('BPJS Tenagakerja'), 'type': 'Deduction'},
		{'doctype': 'Salary Component', 'salary_component': _('BPJS Kesehatan'), 'description': _('BPJS Kesehatan'), 'type': 'Deduction'},
		{'doctype': 'Salary Component', 'salary_component': _('THR'), 'description': _('THR'), 'type': 'Earning'},
		...
		{'doctype': 'Department', 'department_name': _('Warehouse')},
		...
		{'doctype': 'Designation', 'designation_name': _('Staff')},
		...
		{'doctype': 'Designation', 'designation_name': _('Purchasing Manager')},
		...
		{'doctype': 'Designation', 'designation_name': _('Commisioner')},
		...
		{'doctype': "Item Attribute", "attribute_name": _("Colour"), "item_attribute_values": [
			{"attribute_value": _("Red"), "abbr": _("RED")},
			{"attribute_value": _("Green"), "abbr": _("GRE")},
			{"attribute_value": _("Blue"), "abbr": _("BLU")},
			{"attribute_value": _("Black"), "abbr": _("BLA")},
			{"attribute_value": _("White"), "abbr": _("WHI")}
		]},

		# Lead Source
		{'doctype': "Email Account", "email_id": "penjualan@contoh.com", "append_to": "Opportunity"},
		{'doctype': "Email Account", "email_id": "dukungan@contoh.com", "append_to": "Issue"},
		{'doctype': "Email Account", "email_id": "lowongan@contoh.com", "append_to": "Job Applicant"},
		...
		{'doctype': "Opportunity Type", "name": _("Exhibition")},
		...
		{"doctype": "Offer Term", "offer_term": _("Allowances")},
