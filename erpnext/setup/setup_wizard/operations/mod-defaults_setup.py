...
def create_territories():
	...
	stock_settings.default_warehouse = frappe.db.get_value('Warehouse', {'warehouse_name': _('Trading-Stores')})
	stock_settings.stock_uom = _("Unit")
	stock_settings.auto_indent = 1
	stock_settings.auto_insert_price_list_rate_if_missing = 1
	stock_settings.automatically_set_serial_nos_based_on_fifo = 1
	# stock_settings.sample_retention_warehouse = frappe.db.get_value('Warehouse', {'warehouse_name': _('Production-Finished Goods')})
	stock_settings.save()

	selling_settings = frappe.get_doc("Selling Settings")
	selling_settings.cust_master_name = "Customer Name"
	selling_settings.so_required = "Yes"
	selling_settings.dn_required = "No"
	selling_settings.allow_multiple_items = 1
	selling_settings.campaign_naming_by = "Campaign Name"
	selling_settings.allow_against_multiple_purchase_order = 1
	# selling_settings.territory = args.get("country")
	selling_settings.save()

	buying_settings = frappe.get_doc("Buying Settings")
	buying_settings.supp_master_name = "Supplier Name"
	buying_settings.po_required = "Yes"
	buying_settings.pr_required = "Yes"
	buying_settings.maintain_same_rate = 1
	buying_settings.allow_multiple_items = 1
	# buying_settings.supplier_type ="Raw Material"
